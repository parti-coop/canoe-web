class Ability
  ...
  def initialize(user)
    ...
    if user
      ...
      can [:read, :create], [Category, SailingDiary, Wiki, Discussion, Opinion, Comment, ProposalRequest, Proposal, Vote, ConsensusRevision] do |model|
      ...
      can [:destroy, :update], [Category, Wiki] do |model|
        model.canoe.member? user
      end
